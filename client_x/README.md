...
Welcome to Client X's online backstage. The following document is intended for either the site's editors or future developers (aka the webmaster) and designers.
...
- `DEV-DOCS.md` - overview of Client X's Airtable integration.
...
- `drink01.jpg` - photo of the Monthly Drink on the homepage. For maintenance reasons, avoid changing the file name when uploading a new photo.
- `index.njk` - 11ty template for generating the homepage: notice on the top, Monthly Drink, and the events table.
...
- `drink.njk` - the layout for the Monthly Drink section on the homepage.
...
- `deferMap.js` - script for loading the Google map in the footer only when the user scrolls down and reaches it.
...
`src/static`:
- `getraenke01.pdf`, `speisen01.pdf` - drinks and food menus available for download/viewing via the top navigation. (The _More Drinks_ in the Monthly Drink section on the homepage also links to `getraenke01.pdf`).
...
- [About](client_x/client_x_repo/edit/main/src/about.md)
- [Impressum](client_x/client_x_repo/edit/main/src/impressum.md)
- [Privacy policy](client_x/client_x_repo/edit/main/src/privacy-policy.md)
...
The notice, the Monthly Drink, and events sections are all managed via Airtable. To update the content, follow these steps:
1. Open [Airtable](https://airtable.com).
2. Click on the _base_ named [Client X Site Managment](https://airtable.com/df89sspXPHG).
...
#### Upload a new photo of the Monthly Drink
To upload a new photo, follow these steps:
1. Open the [site's repository](client_x/client_x_repo) on GitHub.
2. Click [the `src` directory](src).
3. Click the `Add file` button on the right, and select `Upload files` from the drop-down menu. You can also [click here to navigate directly to the upload window](client_x/client_x_repo/upload/main/src).
...
4. Click the `Add file` button on the right, and select `Upload files` from the drop-down menu. You can also [click here to navigate directly to the upload window](client_x/client_x_repo/upload/main/src/static).
...
5. Click the pencil icon on the right. Alternatively, [click here to navigate directly to the editing window](client_x/client_x_repo/edit/main/src/_data/settings.json).
![Click the pencil icon on the right](edit-on-github.jpg)
...
5. Click the pencil icon on the right. Alternatively, [click here to navigate directly to the editing window](client_x/client_x_repo/edit/main/src/_data/gallery.json).
![Click the pencil icon on the right](edit-on-github.jpg)
...
**Design & development**: Ronny Shani
